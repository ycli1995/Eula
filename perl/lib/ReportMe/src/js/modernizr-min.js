...
window.Modernizr = (function (A, c, g) {
  var J = "2.7.1",
    ...
    G = function (P) {
      ...
      var N;
      n(
        "@media " + P + " { #" + a + " { position: absolute; } }",
        function (Q) {
          N =
            (A.getComputedStyle ? getComputedStyle(Q, null) : Q.currentStyle)[
              "position"
            ] == "absolute";
        },
      );
  ...
  l.canvastext = function () {
    return !!(
      w.canvas &&
      r(c.createElement("canvas").getContext("2d").fillText, "function")
    );
  };
  l.webgl = function () {
  ...
  l.touch = function () {
    ...
    if (
      "ontouchstart" in A ||
      (A.DocumentTouch && c instanceof DocumentTouch)
    ) {
      N = true;
    } else {
      n(
  ...
  l.cssgradients = function () {
    ...
    D(
      (P + "-webkit- ".split(" ").join(O + P) + j.join(N + P)).slice(
        0,
        -P.length,
      ),
    );
  ...
  l.video = function () {
    ...
    try {
      if ((N = !!O.canPlayType)) {
        ...
        N.h264 = O.canPlayType('video/mp4; codecs="avc1.42E01E"').replace(
          /^no$/,
          "",
        );
        N.webm = O.canPlayType('video/webm; codecs="vp8, vorbis"').replace(
          /^no$/,
          "",
        );
      }
  ...
  l.audio = function () {
    ...
    try {
      if ((N = !!O.canPlayType)) {
        ...
        N.m4a = (
          O.canPlayType("audio/x-m4a;") || O.canPlayType("audio/aac;")
        ).replace(/^no$/, "");
      }
    } catch (P) {}
    return N;
  ...
  l.svg = function () {
    return (
      !!c.createElementNS && !!c.createElementNS(H.svg, "svg").createSVGRect
    );
  };
  ...
  l.smil = function () {
    return (
      !!c.createElementNS &&
      /SVGAnimate/.test(b.call(c.createElementNS(H.svg, "animate")))
    );
  };
  l.svgclippaths = function () {
    return (
      !!c.createElementNS &&
      /SVGClipPath/.test(b.call(c.createElementNS(H.svg, "clipPath")))
    );
  };
  function B() {
    w.input = (function (P) {
      ...
      for (var P = 0, O, S, R, N = Q.length; P < N; P++) {
        ...
        if (O) {
          ...
          if (/^range$/.test(S) && L.style.WebkitAppearance !== g) {
            ...
            O =
              R.getComputedStyle &&
              R.getComputedStyle(L, null).WebkitAppearance !== "textfield" &&
              L.offsetHeight !== 0;
            M.removeChild(L);
          } else {
  ...
  (function (X, Z) {
    ...
    (function () {
      try {
        ...
        ad = "hidden" in ag;
        R =
          ag.childNodes.length == 1 ||
          (function () {
            Z.createElement("a");
            var ai = Z.createDocumentFragment();
            return (
              typeof ai.cloneNode == "undefined" ||
              typeof ai.createDocumentFragment == "undefined" ||
              typeof ai.createElement == "undefined"
            );
          })();
      } catch (ah) {
        ad = true;
    ...
    function aa(aj, ag, ai) {
      ...
      return ah.canHaveChildren && !U.test(aj) && !ah.tagUrn
        ? ai.frag.appendChild(ah)
        : ah;
    }
    function ae(ai, ak) {
      if (!ai) {
    ...
    function af(ag, ah) {
      ...
      ag.createDocumentFragment = Function(
        "h,f",
        "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" +
          Y()
            .join()
            .replace(/[\w\-]+/g, function (ai) {
              ah.createElem(ai);
